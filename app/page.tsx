...
export default function Home() {
  ...
  return (
    <main className="flex flex-col min-h-screen text-zinc-900 bg-light-pattern overflow-x-hidden selection:bg-yellow-400">
      
      <div className="bg-yellow-400 text-red-900 font-bold text-[10px] sm:text-xs md:text-sm py-2 marquee-container border-b border-yellow-500 z-[60]">
      ...
      <nav className="bg-white/90 backdrop-blur-md sticky top-0 z-50 shadow-sm border-b border-gray-100 h-20 md:h-24 transition-all duration-300">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-12 mb-16 text-center md:text-left">
            ...
            <div className="flex flex-col items-center md:items-start gap-6">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-11 h-11 bg-red-600 text-white rounded-full flex items-center justify-center hover:bg-black transition shadow-md group">
