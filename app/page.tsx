  ...
  return (
    <main className="flex flex-col min-h-screen text-zinc-900 bg-light-pattern selection:bg-yellow-400 overflow-x-hidden">
      ...
      <div className="pt-32 md:pt-44">
        ...
        <section id="menu" className="relative py-16 md:py-24 border-b border-gray-100 overflow-hidden">
          <div 
            className="absolute inset-0 z-0 opacity-10 bg-cover bg-center bg-no-repeat grayscale pointer-events-none"
            style={{ backgroundImage: 'url("/assets/image_fab5c1.png")' }}
          ></div>
          <div className="absolute inset-0 z-0 bg-white/70 backdrop-blur-sm pointer-events-none"></div>
          ...
          <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 max-w-4xl relative z-10">
            <motion.div whileHover={{y:-10}} className="bg-white/80 p-8 md:p-10 rounded-[2.5rem] border border-gray-100 text-center shadow-lg hover:shadow-xl transition-all group backdrop-blur-md">
            ...
            <motion.div whileHover={{y:-10}} className="bg-red-50/80 p-8 md:p-10 rounded-[2.5rem] border border-red-50 text-center shadow-lg hover:shadow-xl transition-all group backdrop-blur-md">
        ...
        <footer className="relative bg-white pt-16 md:pt-24 border-t border-gray-200 mt-auto pb-0 overflow-hidden">
          <div className="absolute inset-0 z-0 opacity-20 pointer-events-none bg-cover bg-center bg-no-repeat grayscale" style={{ backgroundImage: 'url("/assets/outlet-richeese.png")' }}></div>
          <div className="absolute inset-0 z-0 opacity-20 pointer-events-none bg-cover bg-center bg-no-repeat grayscale" style={{ backgroundImage: 'url("/assets/outlet-richeese.jpg")' }}></div>
          <div className="absolute inset-0 z-0 opacity-20 pointer-events-none bg-cover bg-center bg-no-repeat grayscale" style={{ backgroundImage: 'url("/assets/outlet-richeese.jpeg")' }}></div>
          <div className="absolute inset-0 z-0 opacity-20 pointer-events-none bg-cover bg-center bg-no-repeat grayscale" style={{ backgroundImage: 'url("/assets/outlet.png")' }}></div>
          <div className="absolute inset-0 z-0 opacity-20 pointer-events-none bg-cover bg-center bg-no-repeat grayscale" style={{ backgroundImage: 'url("/assets/outlet.jpg")' }}></div>
          ...
          <div className="container mx-auto px-4 md:px-6 lg:px-12 max-w-7xl mb-12 md:mb-16 relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 text-left">
              ...
              <div className="flex flex-col gap-4">
                ...
                <a href="#" className="text-zinc-700 hover:text-[#da251d] text-sm font-semibold transition-colors">Tentang Kami</a>
                <a href="#" className="text-zinc-700 hover:text-[#da251d] text-sm font-semibold transition-colors">Karier</a>
                <a href="#" className="text-zinc-700 hover:text-[#da251d] text-sm font-semibold transition-colors">Lokasi Outlet</a>
                <a href="#" className="text-zinc-700 hover:text-[#da251d] text-sm font-semibold transition-colors">Berita & Promo</a>
              </div>

              <div className="flex flex-col gap-4">
                <h4 className="font-black text-[#7a1811] text-sm uppercase tracking-widest mb-2">Bantuan & Hukum</h4>
                <a href="#" className="text-zinc-700 hover:text-[#da251d] text-sm font-semibold transition-colors">Syarat & Ketentuan</a>
                <a href="#" className="text-zinc-700 hover:text-[#da251d] text-sm font-semibold transition-colors">Kebijakan Privasi</a>
                <a href="#" className="text-zinc-700 hover:text-[#da251d] text-sm font-semibold transition-colors">Kritik & Saran</a>
                <a href="#" className="text-zinc-700 hover:text-[#da251d] text-sm font-semibold transition-colors">Pusat Bantuan</a>
              </div>

              <div className="flex flex-col gap-4 w-full">
                <h4 className="font-black text-[#7a1811] text-sm uppercase tracking-widest mb-2">Hubungi Kami</h4>
                <div className="flex items-start gap-3 text-zinc-700 text-sm font-semibold">
                  <svg className="w-5 h-5 text-[#da251d] mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                  <span>Jl. Margonda Raya No. 427, Pondok Cina, Kec. Beji, Kota Depok, Jawa Barat 16424</span>
                </div>
                <div className="flex items-center gap-3 text-zinc-700 text-sm font-semibold mt-1">
                  <svg className="w-5 h-5 text-[#da251d] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                  <span>1500220 (Customer Service)</span>
                </div>
                <div className="flex items-center gap-3 text-zinc-700 text-sm font-semibold mt-1">
                  <svg className="w-5 h-5 text-[#da251d] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
          ...
          <div className="bg-white/80 border-t border-gray-200 py-6 relative z-10 backdrop-blur-sm">
            <div className="container mx-auto px-4 md:px-6 lg:px-12 max-w-7xl flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-zinc-600 text-[10px] md:text-xs font-bold">© 2026 PT Richeese Kuliner Indonesia. All rights reserved.</p>
              <div className="flex flex-wrap justify-center items-center gap-4 md:gap-6 text-[10px] md:text-xs font-bold text-zinc-600">
